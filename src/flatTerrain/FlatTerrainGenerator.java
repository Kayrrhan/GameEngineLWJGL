...
public class FlatTerrainGenerator extends TerrainGenerator {
	...
	private static final MyFile VERTEX_SHADER = new MyFile("flatTerrain", "flatTerrainVertex.glsl");
	private static final MyFile FRAGMENT_SHADER = new MyFile("flatTerrain", "flatTerrainFragment.glsl");
