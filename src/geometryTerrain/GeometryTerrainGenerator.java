...
public class GeometryTerrainGenerator extends TerrainGenerator {
	...
	private static final MyFile VERTEX_SHADER = new MyFile("geometryTerrain", "geoTerrainVertex.glsl");
	private static final MyFile GEOMETRY_SHADER = new MyFile("geometryTerrain", "geoTerrainGeometry.glsl");
	private static final MyFile FRAGMENT_SHADER = new MyFile("geometryTerrain", "geoTerrainFragment.glsl");
