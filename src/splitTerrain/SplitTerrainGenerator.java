...
public class SplitTerrainGenerator extends TerrainGenerator {
	...
	private static final MyFile VERTEX_SHADER = new MyFile("splitTerrain", "basicTerrainVertex.glsl");
	private static final MyFile FRAGMENT_SHADER = new MyFile("splitTerrain", "basicTerrainFragment.glsl");
